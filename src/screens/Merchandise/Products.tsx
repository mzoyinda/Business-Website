...
import Automobile from "../../assets/vehicle.png";
import Danest from "../../assets/danest.png";
import Digitrad from "../../assets/market.png";
import PlusMoist from "../../assets/plusmoist.png";
import UsedLaptops from "../../assets/usedlaptops.png";
...
const Products = () => {
  const AllProducts = [
    ...
    },
    {
      name: "Used Laptops",
      description:
        "Standage imports high quality used laptops ranging from Hp, Dell, and MacBooks. This is an avenue to get highly functional laptops at a pocket friendly price. Pre-owned laptops can be a great way to get a reliable device.",
      image: UsedLaptops,
    ...
    },
    {
      name: "Plus Moist",
      description:
        "These wound dressings are designed to provide superior protection and promote healing for a wide range of wounds. Whether you're dealing with a minor cut, a burn, or a more serious injury, these wound dressings have got you covered.",
      image: PlusMoist,
      link:"https://plusmoist.com.ng/"
    },
    {
    ...
    },
    {
      ...
      image: Automobile,
      link:"https://standageautos.com.ng/"
    },
  ...
  return (
    <ProductsContainer>
      ...
      {AllProducts.map((product) => (
        <div key={product.name} className="flexbox" data-aos="slide-up" data-aos-duration="1000">
          <img
            src={product.image}
            alt={product.name}
