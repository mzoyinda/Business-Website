    ...
    <HeaderContainer>
      <div className="wrapper">
        ...
        <div className="description">
          ...
          <p>
            Kenad and Standage Limited is an IT Solutions & Trading company. We
            develop digital platforms for international trading, connecting
            businesses in Africa with companies in Japan. We aim to help
            businesses and users from one end of the chain to another.
          </p>
        </div>
      </div>
