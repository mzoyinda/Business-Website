    ...
    <BlogContainer>
      ...
      {posts.length === 0 ? (
        ...
        <div className="blog__section">
          <div className="blog">
            <div className="flexbox"  onClick={() => handleClick(posts[0].id)}>
              <img
            ...
            <div className="flexbox" onClick={() => handleClick(posts[1].id)}>
              <img
          ...
          <div className="blog">
            <div className="flexbox" onClick={() => handleClick(posts[2].id)} >
              <img
