      ...
      <div className="wrapper">
        ...
        <div className="container">
          <div className="address">
            <h4 className="orange lagos">Lagos Office</h4>
            <p className="city">
              No 1, Adedotun Dina Crescent, Mende Maryland, Lagos. Nigeria
            </p>
            <div className="box">
              <FiMail />
          ...
          <div className="address">
            ...
            <p className="city">
            Sumitomo Shibadaimon Building 0.2, 4F, 1-12-16 Shibadaimon
